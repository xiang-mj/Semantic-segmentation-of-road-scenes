...
First of all, please download the Cityscapes dataset from [here](https://www.cityscapes-dataset.com/)；Download the Camvid dataset according to the [tutorial](https://github.com/alexgkendall/SegNet-Tutorial/tree/master/CamVid)；Download the ADE20K dataset at ADE20K [webpage](https://groups.csail.mit.edu/vision/datasets/ADE20K/).
