...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("./pretrained_models/resnet-50.pth", map_location='cpu'))
    return model
...
def resnet101(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("./pretrained_models/resnet-101.pth",map_location='cpu'))
    return model
